...
class Redis extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $dataSantri = $this->dataModel->fetchDataFromGoogleSheet('1boWrAxm6N9I91ZpPShnjm8KopWTSsWwjN-okUZzIVbk', 'Form Responses 1');

            // Get data santri from Google Sheet
            $dataWali = $this->dataModel->fetchDataFromGoogleSheet('16LXFhZRbaFbGSxtyRotHY_AUSNMXdXYCe_zcXfxGp-U', 'Form Responses 1');
